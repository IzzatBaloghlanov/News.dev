...
const NewsItem = ({ title, description, imageUrl, newsUrl }) => {
    return (
        ...
        <div className="card bg-dark text-light mb-5 my-5 d-inline-block my-3 mx-3 px-2 py-2" style={{ maxWidth: "366px" }}>
            <img src={imageUrl ? imageUrl : img} style={{ height: "230px", width: "350px" }} className="card-img-top" alt="..." />
